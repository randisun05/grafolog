  ...
  <header ref="headerRoot" class="app-navbar">
    ...
    >
      ...
      <template v-if="auth.isAuthenticated">
        ...
        <RouterLink v-if="auth.isAdministrator" to="/admin/games">Kelola Games</RouterLink>
        ...
        <RouterLink v-if="auth.isAdministrator" to="/admin/notification-logs">Log Notifikasi</RouterLink>
        ...
        <RouterLink v-if="auth.isSupervisor" to="/supervisor/potensi">Dashboard Potensi</RouterLink>
        <RouterLink v-if="auth.isSupervisor" to="/supervisor/chat">Asisten Chat</RouterLink>
